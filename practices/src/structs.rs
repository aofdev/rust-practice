...
impl RandomInfo {
    fn new(param_a: i8) -> Self {
        //capital Self is the type of self
        Self {
            some_int: param_a,
            some_float: 9.0,
            call_count: 0,
    ...
    fn is_smaller(&mut self, compare_to: i8) -> bool {
        //lowercase self is the struct itself, with the & borrowing memory from the heap
        self.call_count += 1;
